      ...
      <div className="min-h-screen bg-white flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto px-4 py-5 space-y-4 pb-36">
          ...
          <div className="card">
            ...
            />
            <DetailRow label="Departure" value={listing.departureTime} />
            <DetailRow
              label="Seats"
                ...
                {riders.map((booking, i) => (
                  <div key={booking._id} className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {booking.rider?.mobile && (
                        <p className="text-xs text-gray-500">+91 {booking.rider.mobile}</p>
                      )}
                    </div>
                    {booking.rider?.mobile && (
                      <a
                        href={`tel:+91${booking.rider.mobile}`}
