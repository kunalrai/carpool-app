    ...
    <div className="flex flex-col min-h-screen" style={{ background: "#0f172a" }}>
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <p className="font-semibold text-white">Ride Group Chat</p>
          <button
            onClick={() => setShowParticipants((v) => !v)}
            className="flex items-center gap-1 text-xs mt-0.5 active:opacity-70"
            style={{ color: "#818cf8" }}
          >
      ...
      <AnimatePresence>
        {showParticipants && participants && (
          <motion.div
            ...
            style={{ borderBottom: "1px solid rgba(99,102,241,0.2)", background: "rgba(99,102,241,0.07)" }}
          >
              ...
              <div className="flex flex-wrap gap-2">
                {participants.map((p) => (
                  <div
                    ...
                    style={{ background: "rgba(255,255,255,0.08)", border: "1px solid rgba(99,102,241,0.2)" }}
                  >
                    <div
                    ...
                    <span className="text-xs font-medium" style={{ color: "rgba(255,255,255,0.8)" }}>{p.name}</span>
                    {p.isDriver && (
                      <span className="text-[9px] font-semibold px-1 rounded" style={{ background: "rgba(99,102,241,0.3)", color: "#818cf8" }}>
                        Driver
                      </span>
                    )}
                  </div>
      ...
      <AnimatePresence>
        {activeCall && activeCall.callerId !== userId && (
          ...
          >
            ...
            <p className="flex-1 text-white text-sm font-semibold min-w-0 truncate">{activeCall.callerName} started a group call</p>
            <button
              onClick={() => navigate(`/call/group/${listingId}`)}
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3 pb-28">
        ...
        {messages && messages.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-xs mt-1" style={{ color: "rgba(255,255,255,0.3)" }}>Be the first to say something</p>
          </div>
        )}
        ...
        {messages && messages.map((msg, i) => {
          ...
          return (
            ...
            >
              {showName && (
                <p className="text-xs mb-1 ml-1" style={{ color: "rgba(255,255,255,0.4)" }}>{msg.senderName}</p>
              )}
              <div
